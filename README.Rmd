...
```
What we really need is the matrix consists of species detection/non-detection information for each replicate from a sampling unit. This could be done using the following script.
